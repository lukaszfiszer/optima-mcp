...
- No connect tool, no restore tool. The data source is fixed at server startup from CLI arguments ([`03`](03-architecture.md) §3.6).
...
- **Posture** — whether the login is appropriately read-only ([`03`](03-architecture.md) §3.7).
